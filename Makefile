...
EXECUTION		=	 ft_lstsize.c ft_strcmp.c ft_strncmp.c ft_putstr_fd.c get_next_line.c exe_utils2.c exex1.c exec2.c exec3.c export_things.c ft_blt.c argv_convert.c exe_utils1.c execution.c 
